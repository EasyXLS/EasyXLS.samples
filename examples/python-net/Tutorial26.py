...
and to create a pivot chart. The pivot chart is added to
a workshet and also to a separate chart sheet.
------------------------------------------------------"""
...
from EasyXLS.Charts import *
from EasyXLS.Constants import *

print("Tutorial 26\n----------\n")

# Create an instance of the class that exports Excel files, having two sheets
workbook = ExcelDocument(2, 1)
...
# Create pivot chart
xlsPivotChart1 = ExcelPivotChart()
...
xlsPivotChart2 = ExcelPivotChart()
xlsPivotChart2.setSize(970, 630)
xlsPivotChart2.easy_setChartType(Chart.CHART_TYPE_PYRAMID_BAR)
