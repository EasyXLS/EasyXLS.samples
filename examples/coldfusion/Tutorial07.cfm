...
This code sample shows how to export an Excel file in ColdFusion
...
<!-- Export Excel file -->
Writing file C:\Samples\Tutorial07 - cell comment in Excel.xlsx<br>
<cfset ret = workbook.easy_WriteXLSXFile("C:\Samples\Tutorial07 - cell comment in Excel.xlsx")>
