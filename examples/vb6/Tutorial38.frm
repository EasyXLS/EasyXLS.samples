...
Private Sub Form_Load()
	...
	' Tutorial 38
	'
	' This tutorial shows how to read an Excel XLSB file in VB6
    ...
    If (workbook.easy_LoadXLSBFile("C:\Samples\Tutorial29.xlsb")) Then
        ...
        Me.Label1.Caption = Me.Label1.Caption & vbCrLf & "Writing file C:\Samples\Tutorial38 - read XLSB file.xlsb"
        ...
        End If
    Else
        Me.Label1.Caption = Me.Label1.Caption & vbCrLf & "Error reading file C:\Samples\Tutorial29.xlsb" & vbCrLf & workbook.easy_getError()
    End If
