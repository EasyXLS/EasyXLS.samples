...
Private Sub Form_Load()
	...
	' Tutorial 32
	'
	' This tutorial shows how to export data to XML Spreadsheet file in VB6.
	'=======================================================================
    
	DataType.Initialize
    Styles.Initialize
    
    Me.Label1.Caption = "Tutorial 32" & vbCrLf & "---------------" & vbCrLf
    ...
    Me.Label1.Caption = Me.Label1.Caption & vbCrLf & "Writing file C:\Samples\Tutorial32 - export XML spreadsheet file.xml"
