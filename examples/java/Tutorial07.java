...
/*-------------------------------------------------------------
 | Tutorial 07
 |
 | This code sample shows how to export an Excel file in Java
...
public class Tutorial07 {
  ...
  public static void main(String[] args) {
    try {
      System.out.println("Tutorial 07");
      System.out.println("----------");
      ...
      // Export Excel file
      System.out.println("Writing file: C:\\Samples\\Tutorial07 - cell comment in Excel.xlsx");
