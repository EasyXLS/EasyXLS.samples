...
having multiple sheets. The first sheet is filled with data and
the first cell of the second row contains data in rich text format.
----------------------------------------------------------------"""
...
sFormattedValue += "\n<b>This</b> <i>is</i> <font color=red face=\"Arial Black\" "
"size=15pt><underline double>formatted</underline double></font> <s>text</s>."

# Set the rich text value in cell
xlsFirstTable.easy_getCell(1, 0).setHTMLValue(sFormattedValue)
xlsFirstTable.easy_getCell(1, 0).setDataType(gateway.jvm.DataType.STRING)
