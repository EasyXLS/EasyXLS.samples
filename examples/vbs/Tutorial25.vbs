    ...
    WScript.StdOut.WriteLine("Tutorial 25" & vbcrlf & "----------" & vbcrlf)
	...
	Dim PIVOTTABLE_PIVOT_STYLE_DARK_11
    PIVOTTABLE_PIVOT_STYLE_DARK_11 = "PivotStyleDark11"
    ...
    ' Export Excel file
    WScript.StdOut.WriteLine("Writing file C:\Samples\Tutorial25 - pivot table in Excel.xlsx")
