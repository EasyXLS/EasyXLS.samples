<?php require_once("http://localhost:8080/JavaBridge/java/Java.inc");
	...
	$xlsTab1->easy_addHyperlink($HYPERLINKTYPE_URL, "http://www.euoutsourcing.com", "Link to URL", "B2:E2");

	// Create hyperlink to file
	$xlsTab1->easy_addHyperlink($HYPERLINKTYPE_FILE, "c:\\myfile.xls", "Link to file", "B3");

	// Create hyperlink to UNC
	$xlsTab1->easy_addHyperlink($HYPERLINKTYPE_UNC, "\\\\computerName\\Folder\\file.txt", "Link to UNC", "B4:D4");
